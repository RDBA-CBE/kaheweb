...
import data from "../../../JSON/OfficeOfInternationAffairs/CollaborationAndExchanges.json";
...
const CollaborationAndExchanges = (props) => {
...
export default CollaborationAndExchanges;
