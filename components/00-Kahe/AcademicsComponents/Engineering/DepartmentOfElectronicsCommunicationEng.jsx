...
import data from "@/JSON/ACADEMIC/Engineering/dept_of_electronics_communication_eng.json";
...
const DepartmentOfElectronicsCommunicationEng = () => {
...
export default DepartmentOfElectronicsCommunicationEng;
