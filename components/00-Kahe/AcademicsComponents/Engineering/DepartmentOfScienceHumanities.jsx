...
import data from "@/JSON/ACADEMIC/Engineering/dept_of_science_huminity.json";
...
const DepartmentOfScienceHumanities = () => {
...
export default DepartmentOfScienceHumanities;
