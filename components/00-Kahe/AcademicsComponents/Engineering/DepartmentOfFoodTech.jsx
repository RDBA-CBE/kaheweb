...
import data from "@/JSON/ACADEMIC/Engineering/dept_of_food_tech.json";
...
const DepartmentOfFoodTech = () => {
  const breadcrumbItems = [
    ...
    { label: 'Department of Food Technology' },
  ];
...
export default DepartmentOfFoodTech;
